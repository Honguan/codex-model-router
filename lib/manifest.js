...
export const LEGACY_TEMPLATES = {
  terra: [previousTerra],
  luna: [legacyLunaV12, previousLuna, withReasoning(previousLuna, "max")],
  sol: [legacySolWorkspaceWrite, legacySolReadOnly, previousSol],
  skill: [legacySkillWorkspaceWrite, legacySkillReadOnly, legacySkillAdaptiveV2, previousSkill],
