...
export const LEGACY_TEMPLATES = {
  ...
  skill: [legacySkillWorkspaceWrite, legacySkillReadOnly, legacySkillAdaptiveV2],
  planning: []
};
...
export const SKILL_EXPECTATIONS = Object.freeze({
  skill: Object.freeze({
    name: "model-router",
    required: Object.freeze(["primary model", "matching primary", "Terra", "Luna", "Sol", "three cycles"])
  }),
